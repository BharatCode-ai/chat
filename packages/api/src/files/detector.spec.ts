...
describe('MIME Sniifing and Validation Helpers', () => {
  ...
  const createZipBuffer = (innerFile?: string) => {
    if (innerFile === 'word/document.xml') {
      return Buffer.from('', 'base64');
    }
    if (innerFile === 'xl/workbook.xml') {
      return Buffer.from('', 'base64');
    }
    if (innerFile === 'ppt/presentation.xml') {
      return Buffer.from('', 'base64');
    }
  ...
  describe('sniffMimeType', () => {
    ...
    it('should fallback to application/zip for OOXML missing _rels/.rels', async () => {
      // DOCX missing _rels/.rels
      const corruptOOXML = Buffer.from('', 'base64');
      expect(await sniffMimeType(corruptOOXML)).toBe('application/zip');
    });
